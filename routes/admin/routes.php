...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'middleware' => ['admin']], function () {
    ...
    Route::get('add-new', [ColorController::class, 'getAddView'])->name('add-new');
    Route::post('add-new', [ColorController::class, 'add'])->name('store'); // changed name to 'store' (better)
    Route::get('edit/{id}', [ColorController::class, 'getUpdateView'])->name('edit');
    Route::post('edit/{id}', [ColorController::class, 'update'])->name('update');
    Route::post('delete', [ColorController::class, 'delete'])->name('delete');
    Route::post('status-update', [ColorController::class, 'updateStatus'])->name('status-update');
});
