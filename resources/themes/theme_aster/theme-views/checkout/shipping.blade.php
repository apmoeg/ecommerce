                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="row mb-30">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="form-group mb-3">
                                                                <label class="d-none" for="city">{{ translate('city') }}</label>
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="form-group mb-3">
                                                                ...
                                                                @else
                                                                    <input type="hidden" class="form-control" id="zip"
                                                                           name="zip" value="NA"
                                                            ...
                                                            <div class="row mb-30">
                                                                ...
                                                                <div class="col-sm-6">
                                                                    <div class="form-group mb-3">
                                                                        ...
                                                                        <input type="hidden" name="billing_city" value="NA"
                                                                               id="billing-city"
                                                                               placeholder="{{ translate('ex') }}: {{translate('Dhaka')}}"
                                                                ...
                                                                <div class="col-sm-6">
                                                                    <div class="form-group mb-3">
                                                                        ...
                                                                        @else
                                                                            <input type="hidden" class="form-control" value="NA"
