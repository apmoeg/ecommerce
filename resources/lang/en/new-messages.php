...
return [
	...
	"collect_cash" => "Collect cash",
	"collect_coupons_from_stores_and_apply_to_get_special_discount_from_stores" => "Collect coupons from stores and use them to get exclusive discounts",
	...
	"featured deal 123" => "Featured deal 123",
	...
	"the_fixed_commission_field_is_required" => "The fixed commission field is required",
	"the_fixed_commission_value_field_must_be_at_least_min" => "The fixed commission value field must be at least min",
	...
	"for_Ready_Product_deliveries,_customers_can_pay_&_instantly_download_pre-uploaded_digital_products._For_Ready_After_Sale_deliveries,_customers_pay_first,_then_admin_uploads_the_digital_products_that_become_available_to_customers_for_download" => "For Ready Product deliveries  customers can pay & instantly download pre-uploaded digital products. For Ready After Sale deliveries  customers pay first  then admin uploads the digital products that become available to customers for download",
	"category') AND 1=1 UNION ALL SELECT 1,NULL,table_name FROM information_schema.tables WHERE 2>1--/**/" => "Category ) AND 1=1 UNION ALL SELECT 1 NULL table name FROM information schema.tables WHERE 2 1--/**/",
	"category') AND 1=1 UNION ALL SELECT 1,NULL,table name FROM information schema.tables WHERE 2>1   ** " => "Category ) AND 1=1 UNION ALL SELECT 1 NULL table name FROM information schema.tables WHERE 2 1 ** ",
	"if_a_user_still_do_not_have_it,_they_will_be_requested_a_force_app_update_when_they_opens_the_app" => "If a user still do not have it  they will be requested a force app update when they opens the app",
	"Finally,_click_Update_to_save_the_changes." => "Finally  click Update to save the changes.",
	...
	"<script>alert('XSS')</script>" => " script alert( XSS ) /script ",
	"<script>alert('XSS')< script>" => " script alert( XSS )  script ",
	"Vendor not found or not approved" => "Vendor not found or not approved",
	"Account_Activate" => "Account Activate",
	"The code format is invalid." => "The code format is invalid.",
	"brand'nvOpzp; AND 1=1 OR (<'>iKO))," => "Brand nvOpzp  AND 1=1 OR (   iKO)) ",
	"Sorry_no_data_found_related_to_your_search" => "Sorry no data found related to your search",
	"terms_and_Condition" => "Terms and Condition",
	"color_images_is_required" => "Color images is required",
	"Color images is required!" => "Color images is required!",
