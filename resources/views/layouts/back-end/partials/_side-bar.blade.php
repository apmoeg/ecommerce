...
<div id="sidebarMain" class="d-none">
    ...
    <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
       href="javascript:" title="{{translate('colors')}}">
        <i class="tio-paint nav-icon"></i>
        <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
            {{translate('colors')}}
        </span>
    </a>
    <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
        ...
        <li class="nav-item {{Request::is('admin/color/'.Color::ADD[URI])?'active':''}}">
            <a class="nav-link" href="{{route('admin.color.add-new')}}">
                <span class="tio-circle nav-indicator-icon"></span>
                <span class="text-truncate">{{translate('add_new')}}</span>
            </a>
        </li>
        <li class="nav-item {{Request::is('admin/color/'.Color::LIST[URI])?'active':''}}">
