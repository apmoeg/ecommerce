            ...
            <table class="border bs-0" style="border-radius:12px;">
                @if ($order->order_type == 'default_type')
                    ...
                    <tr>
                        ...
                        @if($order->billing_address_data)
                            <td colspan="2" class="fz-10 border-left vertical-align-top d-none" style="padding:8px 16px;">
                                    <?php
                        ...
                        @endif
                        <td colspan="2" class="fz-10 vertical-align-top  {{$direction === "rtl" ? '' : 'border-left'}} d-none" style="padding:8px 16px;">
                            ...
                            @else
                                ...
                                <div class="">
                                    ...
                                    @if (isset($order->customer) && $order->customer['id']!=0)
                                        <div class="font-normal mt-6px d-none">
                ...
                @else
                    <tr>
                        ...
                        <td class="border-bottom" style="padding:23px 8px">
                            <div class="font-normal mb-1 fz-10 d-none">{{translate('Phone')}}</div>
                            <div
                                class="font-semibold fz-10 d-none">{{$order->customer !=null? $order->customer['phone']: translate('phone_not_found')}}</div>
                        </td>
                        <td class="border-bottom" style="padding:23px 8px">
