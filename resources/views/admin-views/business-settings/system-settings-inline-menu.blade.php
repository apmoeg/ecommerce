...
<div class="inline-page-menu my-4">
    <ul class="list-unstyled">
        ...
        <li class="{{ Request::is('admin/system-settings/'.SoftwareUpdate::VIEW[URI]) ?'active':'' }} d-none">
        ...
        <li class="{{ Request::is('admin/business-settings/web-config/'.DatabaseSetting::VIEW[URI]) ?'active':'' }} d-none">
