            ...
            <div class="card-body">
                <form action="{{route('admin.business-settings.web-config.environment-setup')}}" method="post"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-12">
                            <div class="form-group">
                                ...
                                <select name="app_debug" class="form-control js-select2-custom" disabled>
                        ...
                        <div class="col-md-4 col-12">
                            <div class="form-group">
                                ...
                                <select name="app_mode" class="form-control js-select2-custom" disabled>
                    ...
                    <div class="d-flex justify-content-end flex-wrap gap-3">
                        <button type="reset" class="btn btn-secondary px-5 d-none">{{translate('reset')}}</button>
                        <button type="{{env('APP_MODE')!='demo'?'submit':'button'}}"
                                class="btn btn--primary px-5 {{env('APP_MODE')!='demo'?'':'call-demo'}} d-none">{{translate('submit')}}</button>
                    </div>
                </form>
            </div>
        </div>
                            ...
                            <form action="{{route('admin.business-settings.web-config.environment-https-setup')}}" method="post"
                                ...
                                <div>
                                    <div class="form-group">
                                        ...
                                        <select name="force_https" class="form-control js-select2-custom" disabled>
                                ...
                                <div class="d-flex justify-content-end flex-wrap gap-3">
                                    <button type="submit" class="btn btn--primary px-5 d-none">
                                        {{ translate('Update') }}
                                    </button>
                                </div>
                            </form>
                            ...
                            <form action="{{ route('admin.business-settings.web-config.optimize-system') }}" method="post"
                                ...
                                <div>
                                    <div class="form-group">
                                        ...
                                        <select name="optimize_type" class="form-control js-select2-custom" disabled>
                            ...
                            <form action="{{route('admin.business-settings.web-config.install-passport')}}" method="post"
                                ...
                                <div>
                                    <div class="form-group">
                                        ...
                                        <select name="status" class="form-control js-select2-custom" disabled>
