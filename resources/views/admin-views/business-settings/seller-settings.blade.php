                ...
                <div class="card-body">
                    <div class="row align-items-end">
                        <div class="col-xl-4 col-md-6">
                            <div class="form-group">
                                <label class="title-color d-flex align-items-center gap-2">
                                    {{ translate('default_commission_percentage')}}
                                    <span class="input-label-secondary cursor-pointer" data-toggle="tooltip"
                                          data-placement="right"
                                          title="{{ translate('set_the_percentage_value_for_the_default_commission_that_will_be_received_from_vendors_on_each_order')}}">
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="form-group">
                                <label class="title-color d-flex align-items-center gap-2">
                                    {{ translate('default_fixed_commission')}}
                                    <span class="input-label-secondary cursor-pointer" data-toggle="tooltip"
                                          data-placement="right"
                                          title="{{ translate('set_the_fixed_amount_for_the_default_commission_that_will_be_received_from_vendors_on_each_product_sold')}}">
                                        <img width="16" src="{{dynamicAsset(path: 'public/assets/back-end/img/info-circle.svg')}}"
                                             alt="">
                                    </span>
                                </label>
                                @php($fixedCommission = getWebConfig('fixed_commission'))
                                <input type="number" class="form-control" name="fixed_commission"
                                       value="{{$fixedCommission ?? 0}}"
                                       placeholder="{{ translate('ex').':'.'10'}}" min="0" step="0.01">
                            </div>
                        </div>
                        <div class="col-xl-4 col-md-6">
