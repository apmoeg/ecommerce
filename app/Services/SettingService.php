...
class SettingService
{
    ...
    public function getSMSModuleValidationData(object $request): array
    {
        ...
        $validation = [
            'gateway' => 'required|in:releans,twilio,nexmo,2factor,msg91,hubtel,paradox,signal_wire,019_sms,viatech,global_sms,akandit_sms,sms_to,alphanet_sms,three_shm',
        ...
        } elseif ($request['gateway'] == 'three_shm') {
            $additional_data = [
                'status' => 'required|in:1,0',
                'appkey' => 'required',
                'authkey' => 'required',
