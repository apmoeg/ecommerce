...
class VendorSettingsController extends BaseController
{
    ...
    public function getView(): View
    {
        ...
        $fixed_commission = $this->businessSettingRepo->getFirstWhere(params: ['type' => 'fixed_commission']);
        if (!isset($fixed_commission)) {
            $this->businessSettingRepo->add(data: ['type' => 'fixed_commission', 'value' => 0]);
        }
    ...
    public function update(VendorSettingsRequest $request): RedirectResponse
    {
        ...
        $this->businessSettingRepo->updateOrInsert(type: 'fixed_commission', value: $request->get('fixed_commission', 0));
