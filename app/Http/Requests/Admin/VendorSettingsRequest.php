...
class VendorSettingsRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'fixed_commission' => 'required|min:0',
        ];
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'fixed_commission.required' => translate('the_fixed_commission_field_is_required'),
            'fixed_commission.min' => translate('the_fixed_commission_value_field_must_be_at_least_min'),            
        ];
    }
